...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.ce33d4afa2dfcf7e411e1c2453cd79deddf09a573edb223f34fc6222a384550d.js',function(){input.required=false;search();});}
